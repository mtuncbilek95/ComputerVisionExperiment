function(SetupConfig)
	if(WIN32)
		add_compile_definitions(EXPERIMENT_WINDOWS)
	elseif(UNIX)
		add_compile_definitions(EXPERIMENT_LINUX)
	...
	if(CMAKE_BUILD_TYPE STREQUAL "Debug")
		add_compile_definitions(EXPERIMENT_DEBUG)
	endif()

	if(CMAKE_BUILD_TYPE STREQUAL "Release")
		add_compile_definitions(EXPERIMENT_RELEASE)
	endif()
endfunction()